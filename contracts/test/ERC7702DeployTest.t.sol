...
contract EIP7702DeployTest is Test {
    ...
    function setUp() public {
        ...
        erc7702 = new EIP7702(address(masterContract));
    }
    ...
    function test_ExecuteAllowsWhitelistedRecipient() public {
        ...
        assertTrue(
            result,
            "Execute should return true for whitelisted recipient"
        );
    }
